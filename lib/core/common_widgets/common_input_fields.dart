...
Widget commonTextFieldWidget(
    ...
    VoidCallback? onFiledSubmit,
    bool passwordVisible = true,
    String lastIconPath = '',
    String title = '',
    bool disableSpace = false,
    GlobalKey? key}) {
  String emojiRestictedRegrestion =
  ...
  if (inputFormatters != null) {
    ...
    inputFormatters.add(
        FilteringTextInputFormatter.deny(RegExp(emojiRestictedRegrestion)));
  }
  var nullInputFormatter = [
    FilteringTextInputFormatter.deny(RegExp(r'^\s')),
    FilteringTextInputFormatter.deny(RegExp(emojiRestictedRegrestion)),
  ];
  if (disableSpace) {
    nullInputFormatter.add(FilteringTextInputFormatter.deny(RegExp(r'\s')));
    //r'^[^\s]*\s+$'
  }
          ...
          Expanded(
            child: CommonClick(
              ...
              child: TextFormField(
                ...
                inputFormatters: inputFormatters ?? nullInputFormatter,
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                          color: lightColorPalette.liteGrey, width: 2.w)),
                  focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                          color: lightColorPalette.liteBlue, width: 2.w)),
                  ...
                  hintText: hint,
                  hintStyle: CustomTextTheme.normalTextStyle(
                      color: lightColorPalette.hintGrey),
                ),
                style: CustomTextTheme.normalTextStyle(),
              ),
            ),
  ...
  ).marginSymmetric(horizontal: 2.5.w);
}
